 ...
 */
public final class NearestNeighborSearchOnKDTree< O extends RealLocalizable, T extends MappedElement >
	implements NearestNeighborSearch< O >, Sampler< O >
{
	...
	{
		final NearestNeighborSearchOnKDTree< O, T > copy = new NearestNeighborSearchOnKDTree<>( tree );
